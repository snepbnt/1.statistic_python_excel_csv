...
# 경로 파일 체크하기
start_path = 'C:/Users/COM/Desktop/bplace/statics_prj/subway/seoul'
# 파일 리스트
...
df = pd.DataFrame(columns=['region','station_nm','surv_dt','week_dt','inout_type','hour_6_psn_cnt','hour_7_psn_cnt','hour_8_psn_cnt','hour_9_psn_cnt','hour_10_psn_cnt','hour_11_psn_cnt',
...
for file_name in file_list:
    ...
    for sheet_name_list in sheet_name_lists:
        ...
        subway_frame = pd.DataFrame({
            ...
            'hour_6_psn_cnt': subway['6시 이전'],
            'hour_7_psn_cnt' : subway['6시'],
            'hour_8_psn_cnt' : subway['7시'],
            'hour_9_psn_cnt' : subway['8시'],
            'hour_10_psn_cnt' : subway['9시'],
            'hour_11_psn_cnt' : subway['10시'],
            'hour_12_psn_cnt' : subway['11시'],
            'hour_13_psn_cnt' : subway['12시'],
            'hour_14_psn_cnt' : subway['13시'],
            'hour_15_psn_cnt' : subway['14시'],
            'hour_16_psn_cnt' : subway['15시'],
            'hour_17_psn_cnt' : subway['16시'],
            'hour_18_psn_cnt' : subway['17시'],
            'hour_19_psn_cnt' : subway['18시'],
            'hour_20_psn_cnt' : subway['19시'],
            'hour_21_psn_cnt' : subway['20시'],
            'hour_22_psn_cnt' : subway['21시'],
            'hour_23_psn_cnt' : subway['22시'],
            'hour_24_psn_cnt' : subway['23시 이후']
            })
        print(subway_frame)
