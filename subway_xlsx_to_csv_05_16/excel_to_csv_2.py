...
df = pd.DataFrame(columns=['region','station_nm','surv_dt','week_dt','inout_type','hour_6_psn_cnt','hour_7_psn_cnt','hour_8_psn_cnt','hour_9_psn_cnt','hour_10_psn_cnt','hour_11_psn_cnt',
                           'hour_12_psn_cnt','hour_13_psn_cnt','hour_14_psn_cnt','hour_15psn_cnt','hour_16_psn_cnt','hour_17_psn_cnt','hour_18_psn_cnt','hour_19_psn_cnt','hour_20_psn_cnt',
...
for file_name in file_list:
    ...
    # csv 파일 형태로 저장하기
    df.to_csv(f'C:/Users/COM/Desktop/bplace/statics_prj/csv_file/{file_name.replace(".xlsx","")}.csv', sep=',', encoding='euckr')
